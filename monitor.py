### Antes de mais nada rodar 
### .\OneDrive\Documentos\GitHub\SL\slenv\Scripts\activate
### stre
...
SFAccount   = 'quktmvk-lc03355'
SFUser      = 'clovis.vieira'
SFPassword  = 'SetePEC7&7'
...
sf_cursor.execute(f'select * from snowflake.account_usage.login_history')
dfsfq = sf_cursor.fetch_pandas_all()
sf_cursor.close()        
snowflake_conn.close()

st.title('SF Monitor :shopping_trolley:')
...
aba1, aba2, aba3 = st.tabs(['Consumo', 'Segurança', 'Vendedores'])
